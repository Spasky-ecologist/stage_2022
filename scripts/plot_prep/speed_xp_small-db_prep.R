#Plot preperation script for speed_xp.R
...
data <- fread("C:/Users/Spasky/OneDrive - UQAM/20220621 - Stage Patrice Leveille/data/02_final-data.csv",
              select = c("match_encode_id", "predator_id", "pred_speed",
                         "predator_avatar_id", "cumul_xp_killer", "pred_amount_tiles_visited"))
...
saveRDS(table, file = file.path(path, "SP_xp_table_small-db.rds"))
